...
namespace LMIS.Api.Core.Migrations
{
    ...
    [Migration("20231204100133_modifiedModelRelationships")]
    partial class modifiedModelRelationships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LMIS.Api.Core.Model.MemberType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 12, 4, 10, 1, 33, 340, DateTimeKind.Utc).AddTicks(3410),
                            Name = "Student"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 12, 4, 10, 1, 33, 340, DateTimeKind.Utc).AddTicks(3411),
                            Name = "Staff"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2023, 12, 4, 10, 1, 33, 340, DateTimeKind.Utc).AddTicks(3412),
                            Name = "Regular Member"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2023, 12, 4, 10, 1, 33, 340, DateTimeKind.Utc).AddTicks(3413),
                            Name = "Premium Member"
                        },
                        new
                        {
                        ...
                        {
                            Id = 6,
                            CreatedOn = new DateTime(2023, 12, 4, 10, 1, 33, 340, DateTimeKind.Utc).AddTicks(3414),
                            Name = "Senior Citezen"
                        },
                        new
                        {
                            Id = 7,
                            CreatedOn = new DateTime(2023, 12, 4, 10, 1, 33, 340, DateTimeKind.Utc).AddTicks(3415),
