...
namespace LMIS.Api.Core.Migrations
{
    ...
    [Migration("20231203214432_addedMemberGenre")]
    partial class addedMemberGenre
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LMIS.Api.Core.Model.MemberType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 12, 3, 21, 44, 32, 207, DateTimeKind.Utc).AddTicks(7605),
                            Name = "Student"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 12, 3, 21, 44, 32, 207, DateTimeKind.Utc).AddTicks(7608),
                            Name = "Staff"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2023, 12, 3, 21, 44, 32, 207, DateTimeKind.Utc).AddTicks(7609),
                            Name = "Regular Member"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2023, 12, 3, 21, 44, 32, 207, DateTimeKind.Utc).AddTicks(7610),
                            Name = "Premium Member"
                        },
                        new
                        {
                        ...
                        {
                            Id = 6,
                            CreatedOn = new DateTime(2023, 12, 3, 21, 44, 32, 207, DateTimeKind.Utc).AddTicks(7611),
                            Name = "Senior Citezen"
                        },
                        new
                        {
                            Id = 7,
                            CreatedOn = new DateTime(2023, 12, 3, 21, 44, 32, 207, DateTimeKind.Utc).AddTicks(7612),
