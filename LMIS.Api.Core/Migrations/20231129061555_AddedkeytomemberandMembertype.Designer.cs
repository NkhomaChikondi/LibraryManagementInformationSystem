...
namespace LMIS.Api.Core.Migrations
{
    ...
    [Migration("20231129061555_AddedkeytomemberandMembertype")]
    partial class AddedkeytomemberandMembertype
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LMIS.Api.Core.Model.MemberType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 11, 29, 6, 15, 54, 784, DateTimeKind.Utc).AddTicks(9137),
                            Name = "Student"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 11, 29, 6, 15, 54, 784, DateTimeKind.Utc).AddTicks(9139),
                            Name = "Staff"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2023, 11, 29, 6, 15, 54, 784, DateTimeKind.Utc).AddTicks(9140),
                            Name = "Regular Member"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2023, 11, 29, 6, 15, 54, 784, DateTimeKind.Utc).AddTicks(9141),
                            Name = "Premium Member"
                        },
                        new
                        {
                        ...
                        {
                            Id = 6,
                            CreatedOn = new DateTime(2023, 11, 29, 6, 15, 54, 784, DateTimeKind.Utc).AddTicks(9142),
                            Name = "Senior Citezen"
                        },
                        new
                        {
                            Id = 7,
                            CreatedOn = new DateTime(2023, 11, 29, 6, 15, 54, 784, DateTimeKind.Utc).AddTicks(9143),
