...
namespace LMIS.Api.Core.Migrations
{
    ...
    [Migration("20231201154113_newMigration")]
            ...
            modelBuilder.Entity("LMIS.Api.Core.Model.MemberType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 12, 1, 15, 41, 12, 539, DateTimeKind.Utc).AddTicks(5648),
                            Name = "Student"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 12, 1, 15, 41, 12, 539, DateTimeKind.Utc).AddTicks(5649),
                            Name = "Staff"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2023, 12, 1, 15, 41, 12, 539, DateTimeKind.Utc).AddTicks(5651),
                            Name = "Regular Member"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2023, 12, 1, 15, 41, 12, 539, DateTimeKind.Utc).AddTicks(5652),
                            Name = "Premium Member"
                        },
                        new
                        {
                        ...
                        {
                            Id = 6,
                            CreatedOn = new DateTime(2023, 12, 1, 15, 41, 12, 539, DateTimeKind.Utc).AddTicks(5653),
                            Name = "Senior Citezen"
                        },
                        new
                        {
                            Id = 7,
                            CreatedOn = new DateTime(2023, 12, 1, 15, 41, 12, 539, DateTimeKind.Utc).AddTicks(5654),
