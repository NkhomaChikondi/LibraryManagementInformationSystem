...
namespace LMIS.Api.Core.Migrations
{
    ...
    [Migration("20231201114052_addedUserandGenreRelationship")]
    partial class addedUserandGenreRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LMIS.Api.Core.Model.MemberType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 12, 1, 11, 40, 51, 424, DateTimeKind.Utc).AddTicks(4592),
                            Name = "Student"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 12, 1, 11, 40, 51, 424, DateTimeKind.Utc).AddTicks(4595),
                            Name = "Staff"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2023, 12, 1, 11, 40, 51, 424, DateTimeKind.Utc).AddTicks(4596),
                            Name = "Regular Member"
                        },
                        new
                        {
                            Id = 4,
                            CreatedOn = new DateTime(2023, 12, 1, 11, 40, 51, 424, DateTimeKind.Utc).AddTicks(4598),
                            Name = "Premium Member"
                        },
                        new
                        {
                            Id = 5,
                            CreatedOn = new DateTime(2023, 12, 1, 11, 40, 51, 424, DateTimeKind.Utc).AddTicks(4599),
                            Name = "Guest"
                        },
                        new
                        {
                            Id = 6,
                            CreatedOn = new DateTime(2023, 12, 1, 11, 40, 51, 424, DateTimeKind.Utc).AddTicks(4600),
                            Name = "Senior Citezen"
                        },
                        new
                        {
                            Id = 7,
                            CreatedOn = new DateTime(2023, 12, 1, 11, 40, 51, 424, DateTimeKind.Utc).AddTicks(4601),
